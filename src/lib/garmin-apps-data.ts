...
export const GARMIN_APPS_PAGES: Record<string, GarminPage> = {
  ...
  "garmin-pilot-aviation": {
    ...
    alternateQueries: ["garmin pilot app","flygarmin database","flygarmin database update","ifly garmin database update","garmin aviation database update","garmin pilot subscription","garmin pilot ipad","aviation database concierge","garmin pilot setup","fly garmin database update"],
    ...
    faqs: [
      ...
      { q: "How do I do a flyGarmin database update (sometimes searched as 'ifly garmin database update')?", a: "Go to fly.garmin.com, sign in, confirm your aircraft's database subscription is 'Active,' then open Garmin Pilot on your tablet and enable Database Concierge under the Connext page. The app downloads the new AIRAC cycle (every 28 days) automatically; transfer it to your avionics via Flight Stream 510 or an SD card. If flyGarmin shows your subscription as expired or your aircraft isn't linked, that's the #1 reason updates don't appear." },
    ],
