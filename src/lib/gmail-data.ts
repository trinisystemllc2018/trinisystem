...
export type GmailPage = {
  ...
  // ── Long-form content ──
  textSteps: { title: string; detail: string }[];
  whatIfNotWork: { problem: string; fix: string }[];
...
export const GMAIL_PAGES: Record<string, GmailPage> = {
  ...
  "gmail-help": {
    ...
    textSteps: [
      { title: "Pick the topic that matches your question", detail: "Use the list of guides on this page. Each one is written for a specific question seniors ask about Gmail." },
      { title: "Read the short answer at the top", detail: "Every guide starts with a quick answer in 2-3 sentences. If that's enough, you're done. If not, keep reading." },
      { title: "Try the picture walkthrough", detail: "Each guide has a 'Practice Mode' you can click through. It shows you exactly what Gmail looks like and where to click." },
      { title: "Call us if you get stuck", detail: "If anything is confusing, call Trini System at 347-953-1531. We'll walk you through it on the phone — free." },
    ],
    whatIfNotWork: [
      { problem: "I can't find a guide for my problem", fix: "Call us at 347-953-1531 and tell us what you're trying to do. We'll help you over the phone." },
      { problem: "The steps don't look like my Gmail", fix: "Gmail looks slightly different on phones, tablets, and computers. Tell us what you're using when you call and we'll match the right instructions." },
    ],
    faqs: [
  ...
  "gmail-login": {
    ...
    textSteps: [
      { title: "Open your web browser", detail: "On your computer, open Chrome, Safari, Edge, or Firefox. Any web browser works." },
      { title: "Go to gmail.com", detail: "Click on the address bar at the top of the browser. Type gmail.com and press the Enter key on your keyboard." },
      { title: "Type your email address", detail: "Click in the box that says 'Email or phone' and type your full Gmail address — for example, yourname@gmail.com. Then click the blue Next button." },
      { title: "Type your password", detail: "Click in the password box and carefully type your password. Passwords are case-sensitive — capital letters matter. Click the blue Next button." },
      { title: "Verify it's you (if asked)", detail: "Google may send a 6-digit code to your phone by text message, or send a notification asking 'Is it you?' Open your phone, find the code or tap Yes." },
      { title: "You're in!", detail: "Your inbox will load. You'll see a list of your emails. Click any email to read it." },
    ],
    whatIfNotWork: [
      { problem: "It says 'Wrong password'", fix: "Click 'Forgot password?' under the password box and follow our password reset guide. Capital letters and lowercase letters are different — make sure your Caps Lock key is off." },
      { problem: "I don't see the 6-digit code text message", fix: "Check your phone's text messages. The code comes from Google — it's a short number. If it doesn't arrive in 1 minute, click 'Try another way' on the screen." },
      { problem: "It says my account doesn't exist", fix: "Check your spelling — the email address must be exactly right. If you can't remember your full email, see our guide on recovering your Gmail address." },
      { problem: "The page won't load at all", fix: "Try closing and reopening your web browser. Check that your internet is working by visiting another website. If it still doesn't work, restart your computer." },
    ],
    faqs: [
  ...
  "gmail-forgot-password": {
    ...
    textSteps: [
      { title: "Go to gmail.com", detail: "Open your web browser and go to gmail.com." },
      { title: "Type your email address", detail: "Type your full Gmail address (yourname@gmail.com) and click Next." },
      { title: "Click 'Forgot password?'", detail: "Don't type a password. Instead, click the small blue text that says 'Forgot password?' below the password box." },
      { title: "Verify your identity", detail: "Google will offer one or more ways to verify it's you: a code by text message to your phone, a code by email to your backup email, or your last password. Pick the one that works for you." },
      { title: "Type the 6-digit code", detail: "Check the place Google sent the code (your phone or backup email) and type the 6-digit code into the box. Click Next." },
      { title: "Create a new password", detail: "Type a new password — at least 8 characters with letters and numbers. Type it again to confirm. Click Save Password." },
      { title: "You're back in!", detail: "You'll be signed in automatically. Write your new password down somewhere safe so you don't forget it again." },
    ],
    whatIfNotWork: [
      { problem: "I don't have my recovery phone anymore", fix: "Click 'Try another way' on each screen. Google will offer alternatives like your backup email or security questions. If nothing works, see our guide 'How to Recover a Gmail Account Without Phone or Email'." },
      { problem: "I'm not getting the text message code", fix: "Wait 2 minutes — sometimes texts are slow. Check that your phone has signal. If still nothing, click 'Try another way' to use a different recovery method." },
      { problem: "Google says it can't verify me", fix: "This happens if you're trying from a new computer or location. Try again from a device or location where you've signed in before — like your home computer on home WiFi." },
      { problem: "I never set up a recovery phone or email", fix: "You'll need to answer Google's identity questions. Be patient and answer as honestly as possible. If recovery fails, call us at 347-953-1531 — we can help you decide whether to recover or create a new account." },
    ],
    faqs: [
  ...
  "gmail-recover-account": {
    ...
    textSteps: [
      { title: "Go to the recovery page", detail: "Open your browser and type: accounts.google.com/signin/recovery — or just go to gmail.com and click 'Forgot password?'" },
      { title: "Type your email address", detail: "Even if you've forgotten everything else, type the email address you're trying to recover. Click Next." },
      { title: "Try entering your last remembered password", detail: "Even an old one helps. If you don't remember any, click 'Try another way'." },
      { title: "Use your recovery phone or email", detail: "If you have one set up, Google will send a 6-digit code. Type the code in." },
      { title: "If those don't work, answer Google's questions", detail: "Google may ask when you created the account, recent emails you've received, or security questions. Answer as best you can — be patient and don't rush." },
      { title: "Create a new password", detail: "Once Google confirms it's you, set a new password. Make it strong (at least 12 characters) and write it down somewhere safe." },
      { title: "Update your recovery options", detail: "After getting back in, go to Google Account → Security and add a recovery phone and email so this doesn't happen again." },
    ],
    whatIfNotWork: [
      { problem: "Google says 'We couldn't verify it's you'", fix: "Try recovery from a familiar device — a computer or phone you've signed in from before — and on familiar WiFi like your home network. Google trusts these and is more likely to let you in." },
      { problem: "I've tried too many times and got locked out", fix: "Wait 24 hours and try again. Multiple failed attempts trigger a temporary security lock. Don't keep trying — it makes it worse." },
      { problem: "I don't remember my old password or have any recovery info", fix: "It's still possible to recover but takes longer. Google will ask detailed questions about your account history. If recovery fails after multiple attempts, you may need to create a new Gmail account. Call us at 347-953-1531 for help deciding." },
      { problem: "I think someone hacked my account", fix: "Use the same recovery process to take it back, then change your password immediately. After that, go to Security settings and turn on 2-Step Verification, and check 'Recent security activity' to see what was changed." },
    ],
    faqs: [
  ...
  "gmail-cant-sign-in": {
    ...
    walkthrough: [SCREEN_GMAIL_HOMEPAGE, SCREEN_EMAIL_ENTRY, SCREEN_PASSWORD_ENTRY, SCREEN_INBOX],
    textSteps: [
      { title: "Check your Caps Lock key", detail: "Look at your keyboard — if 'Caps Lock' has a light on, press it once to turn off. Passwords are case-sensitive, so 'PASSWORD' is different from 'password'." },
      { title: "Carefully retype your email and password", detail: "Type slowly. Don't paste — typos in copy-paste are a common cause of sign-in failures." },
      { title: "Try the 'Forgot password?' link", detail: "If your password really doesn't work, click 'Forgot password?' under the password box and follow our password reset guide." },
      { title: "Try a different web browser", detail: "If you usually use Chrome, try Edge or Safari. Sometimes a browser glitch blocks sign-in. Just open another browser and go to gmail.com." },
      { title: "Make sure you're on the real Gmail", detail: "The address bar should say gmail.com or accounts.google.com. If it says anything else, close it — that's a scam site trying to steal your password." },
      { title: "Wait if Google says you're locked", detail: "If Google says 'Account temporarily locked,' it's a security pause. Wait 24 hours, then try again from your home computer on home WiFi." },
    ],
    whatIfNotWork: [
      { problem: "It says 'Couldn't find your Google account'", fix: "Your email is wrong. Check the spelling carefully. Common mistakes: missing letters, wrong domain (gmail.com not gmail.co.uk), or using your name instead of your full email address." },
      { problem: "It says 'Wrong password' even though I typed it right", fix: "Reset the password using 'Forgot password?' — sometimes accounts get auto-changed by security alerts. See our forgot password guide for steps." },
      { problem: "Sign-in works but kicks me right back out", fix: "This is usually a browser cookie problem. Close all browser windows, reopen, and try gmail.com again. If that doesn't work, restart your computer." },
      { problem: "I get a 6-digit code prompt but the code doesn't work", fix: "Codes expire after 5 minutes. Click 'Resend' for a new code. If still no luck, click 'Try another way'." },
    ],
    faqs: [
  ...
  "gmail-forgot-username": {
    ...
    textSteps: [
      { title: "Go to the username recovery page", detail: "Open your browser and type: accounts.google.com/signin/usernamerecovery — or go to gmail.com, click Sign In, then 'Forgot email?'" },
      { title: "Enter your recovery phone or email", detail: "Type the phone number or backup email address you set up when you created the Gmail account. Click Next." },
      { title: "Type your full first and last name", detail: "Use the exact name you registered with — including middle initial if you used one." },
      { title: "Get the verification code", detail: "Google sends a 6-digit code to your phone or backup email. Type the code in." },
      { title: "Pick your Gmail from the list", detail: "Google shows all Gmail addresses tied to that phone or email. Click yours." },
      { title: "Sign in with your password", detail: "Now that you have your Gmail address, sign in normally. If you've also forgotten the password, see our forgot password guide." },
    ],
    whatIfNotWork: [
      { problem: "I don't remember my recovery phone or backup email", fix: "Without one of these, finding your Gmail address gets very hard. Try common phone numbers you've owned. If nothing works, you may need to create a new Gmail and tell contacts the new address." },
      { problem: "Google says 'No accounts found'", fix: "The phone or email you typed isn't linked to any Gmail account. Try a different phone number or email — even old ones from years ago." },
      { problem: "I see multiple Gmails in the list and don't know which is mine", fix: "Look at the addresses carefully — yours probably has your name in it. If you still can't tell, try signing in to each one (you only need the password). The one that works is yours." },
    ],
    faqs: [
  ...
  "gmail-two-factor": {
    ...
    textSteps: [
      { title: "Wait a full 2 minutes", detail: "Text messages can be delayed, especially in rural areas. Don't keep clicking 'Resend' — wait 2 minutes first." },
      { title: "Check your text messages app", detail: "Open the messaging app on your phone. Look for a recent text from a 5-digit number with a 6-digit code." },
      { title: "Click 'Resend code'", detail: "If after 2 minutes there's still no code, click 'Resend code' on the Gmail screen." },
      { title: "Try 'Try another way'", detail: "Click this link on the verification screen. Google will offer alternatives like a voice call to your phone, code by email, or your backup codes." },
      { title: "Check that the code isn't expired", detail: "Codes only work for 5 minutes after Google sends them. If you waited too long, request a fresh one." },
      { title: "Type the code carefully", detail: "Six digits, no spaces. The numbers '0' and 'O' are different — codes only use digits 0-9." },
    ],
    whatIfNotWork: [
      { problem: "I changed phones and don't have the old number", fix: "Click 'Try another way' on the verification screen. Use your backup email instead. If you don't have one set up, you'll need to use account recovery — see our recover Gmail guide." },
      { problem: "I don't see any 'Try another way' option", fix: "Scroll down on the verification page — it's sometimes a small link. If it's not there, your account only has one verification method set up. You'll need account recovery." },
      { problem: "Where do I find backup codes?", fix: "If you saved backup codes when you set up 2-Step Verification, look on paper — they're usually 8-digit codes. If you didn't save any, use 'Try another way' for other options." },
      { problem: "The code arrived but it says 'Code is wrong'", fix: "Make sure you didn't include any spaces or extra digits. Codes are exactly 6 digits. If still wrong, request a fresh code — old ones expire." },
    ],
    faqs: [
  ...
  "gmail-send-email": {
    ...
    textSteps: [
      { title: "Click the red 'Compose' button", detail: "It's the big red or blue button in the top-left corner of Gmail. Click it." },
      { title: "Type the recipient's email", detail: "In the 'To' box, type the email address of the person you want to email. Like grandkid@gmail.com." },
      { title: "Add a subject", detail: "In the 'Subject' line, type a short description of your email — like 'Birthday wishes' or 'Doctor appointment'." },
      { title: "Write your message", detail: "Click in the big white box and type whatever you want to say. Don't worry about being formal — just write like you'd talk." },
      { title: "Add a photo (optional)", detail: "To attach a photo, click the small paperclip icon at the bottom of the compose window. Find your photo and click Open." },
      { title: "Click Send", detail: "When you're done, click the blue 'Send' button at the bottom-left. Your email is sent right away." },
    ],
    whatIfNotWork: [
      { problem: "The Send button is grey and won't click", fix: "You probably haven't typed an email address in the 'To' box. Click 'To' and type at least one email — Send will turn blue." },
      { problem: "It says 'Address not found'", fix: "The recipient's email is misspelled or doesn't exist. Double-check the spelling. Common mistakes: missing letters, wrong domain (gmail.com vs yahoo.com)." },
      { problem: "My photo is too big to send", fix: "Gmail allows up to 25 MB. For big videos or many photos, Gmail will automatically offer to send them via Google Drive — just click 'OK'." },
      { problem: "I sent it but want to take it back", fix: "Right after clicking Send, look at the bottom-left for a small black bar that says 'Undo'. You have about 5 seconds to click it. After that, the email is gone for good." },
    ],
    faqs: [
  ...
  "gmail-attach-photo": {
    ...
    textSteps: [
      { title: "Click Compose", detail: "Click the red 'Compose' button at the top-left to start a new email." },
      { title: "Fill in the email basics", detail: "Type the recipient's email in 'To' and a short subject in 'Subject'." },
      { title: "Click the paperclip icon", detail: "At the bottom of the compose window, find the small paperclip icon. Click it." },
      { title: "Find your photo", detail: "A window opens. Browse to where your photo is — on a computer, that's usually 'Pictures'. On a phone, it's your photo gallery." },
      { title: "Click on the photo and click Open", detail: "The photo will upload — you'll see a progress bar. Wait for it to finish (usually 5-10 seconds)." },
      { title: "Type a message and click Send", detail: "Add a short note in the email body, then click the blue Send button." },
    ],
    whatIfNotWork: [
      { problem: "My photo is too big — it says 'Attachment too large'", fix: "Gmail allows up to 25 MB per email. For larger files, Gmail will offer to send the photo via Google Drive — just click 'Yes' and the recipient gets a link to download." },
      { problem: "I don't see a paperclip icon", fix: "If you're using Gmail in 'basic HTML' mode (older browsers), click 'Standard view' at the top. Or update your browser to the latest version." },
      { problem: "The photo won't upload — it just spins", fix: "Your internet may be slow. Wait 1 minute, then try again. If still stuck, close the compose window (it saves as a draft), reopen, and try again." },
      { problem: "I want to send several photos", fix: "Click the paperclip icon, hold the Ctrl key (or Command key on a Mac), and click each photo one by one. They all attach together." },
    ],
    faqs: [
  ...
  "gmail-spam-filter": {
    ...
    textSteps: [
      { title: "Open the unwanted email", detail: "Click on the email in your inbox to open it." },
      { title: "Click the three vertical dots", detail: "In the top-right of the open email (next to the reply arrow), click the three small dots." },
      { title: "Click 'Block [sender name]'", detail: "A menu appears. Click the line that says 'Block' followed by the sender's name." },
      { title: "Click 'Block' to confirm", detail: "Gmail asks if you're sure — click Block. From now on, emails from this address skip your inbox and go to Spam." },
      { title: "For real spam, click 'Report spam'", detail: "Instead of Block, you can click the exclamation-mark icon at the top of the open email. This tells Google the email is spam and helps protect other people too." },
    ],
    whatIfNotWork: [
      { problem: "Spam keeps coming from different addresses", fix: "Real spammers change addresses. Use 'Report spam' instead of 'Block' — Google then blocks similar emails automatically." },
      { problem: "I accidentally blocked someone I want to hear from", fix: "Open Gmail Settings (gear icon) → 'See all settings' → 'Filters and Blocked Addresses'. Find the address and click 'unblock'." },
      { problem: "The Block option isn't there", fix: "You're probably using the basic Gmail view. Click 'Standard view' at the bottom of the screen, then try again." },
      { problem: "Important emails are going to spam", fix: "Open the Spam folder (left side), find the email, and click 'Not spam' at the top. Future emails from that sender will go to your inbox." },
    ],
    faqs: [
  ...
  "gmail-storage-full": {
    ...
    textSteps: [
      { title: "Check your current storage", detail: "Scroll to the bottom of Gmail. You'll see something like '12.5 GB of 15 GB used'. That tells you how full you are." },
      { title: "Search for big emails", detail: "Click the search box at the top of Gmail. Type: larger:10MB and press Enter. Gmail shows your biggest emails." },
      { title: "Delete the biggest ones you don't need", detail: "Look through the list. Old work emails, emails with videos attached, emails from years ago — delete them by clicking the trash can icon." },
      { title: "Empty your Trash and Spam", detail: "Click 'More' on the left, then 'Trash'. Click 'Empty Trash now'. Do the same for Spam folder. This frees up everything you've already deleted." },
      { title: "Clean out Promotions tab", detail: "Click the Promotions tab at the top of your inbox. Select all emails (small box at the top) and click the trash can. These are usually marketing emails you don't need." },
      { title: "Check Google Drive and Photos", detail: "Your 15 GB is shared with Drive and Photos. Visit drive.google.com and photos.google.com to delete old files there too." },
    ],
    whatIfNotWork: [
      { problem: "I'm afraid to delete emails I might need", fix: "Don't delete emails from people you know — only delete obvious junk like old marketing or notifications. If unsure, archive instead of delete (the archive button is right next to delete)." },
      { problem: "I cleaned up but storage is still full", fix: "It can take Gmail up to 24 hours to update your storage number. Wait a day. Also check if Google Photos is using your storage — that's the most common cause." },
      { problem: "I need more space than 15 GB", fix: "You can buy more storage from Google — $1.99 a month for 100 GB. Go to one.google.com to upgrade. But most seniors don't need this — just clean up old emails." },
      { problem: "Storage is full and I can't get new emails", fix: "When you're 100% full, no new emails arrive — they bounce back to senders. Free up at least 1 GB right away by clearing Trash and Spam, then continue cleaning." },
    ],
    faqs: [
  ...
  "gmail-scam-emails": {
    ...
    textSteps: [
      { title: "Look at the sender's email address closely", detail: "Click the small arrow next to the sender's name to see the full address. Real Google emails come from @google.com. Scams use addresses like google-security@xyz.com." },
      { title: "Watch for urgent or scary language", detail: "Scams say things like 'Your account will be closed in 24 hours!' or 'Suspicious activity detected — verify NOW!' Real companies don't pressure you like that." },
      { title: "Never give passwords by email", detail: "Google, your bank, and the IRS will NEVER ask for your password by email. If an email asks, it's a scam. Always." },
      { title: "Check the spelling", detail: "Real companies have professional writers. Lots of typos, weird grammar, or strange phrases ('Dear Valued Costumer') = scam." },
      { title: "Don't click links — go directly", detail: "Even if the email looks real, don't click the link. Open a new browser tab and type the company's website yourself (like google.com or chase.com). Sign in there to check." },
      { title: "Report it as spam and delete", detail: "Click the exclamation-mark icon at the top to report it as spam. Then delete it. Don't reply, don't unsubscribe — that just confirms your email is real to scammers." },
    ],
    whatIfNotWork: [
      { problem: "I already clicked a link in a scam email", fix: "Don't panic. Close the browser tab right away. Don't enter any passwords. Run a virus scan. If you typed a password before realizing, change that password immediately at the real website." },
      { problem: "I gave them my password — what now?", fix: "Change your password right now at the real website. Turn on 2-Step Verification. Check your account for unauthorized changes. Call us at 347-953-1531 if you need help." },
      { problem: "Scammer is calling my phone now", fix: "Hang up immediately. Do not give them any information. They got your phone from somewhere — likely the email scam. Block their number. Tell family members." },
      { problem: "I'm getting tons of these emails", fix: "Mark each as spam (not delete — Spam helps Gmail learn). After a few weeks, Gmail's filter gets very good at catching them automatically." },
    ],
    faqs: [
