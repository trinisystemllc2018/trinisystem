...
export function Footer() {
  return (
    <footer className="bg-black text-white">
      {/* CTA Strip */}
      <div className="py-12 px-4" style={{ background: "linear-gradient(135deg, #1a0a00 0%, #2d1100 100%)", borderBottom: "1px solid rgba(249,115,22,0.2)" }}>
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex gap-3 shrink-0 flex-wrap justify-center">
            <a
              href={PHONE_HREF}
              className="bg-white text-orange-700 font-bold px-6 py-3.5 rounded-2xl hover:bg-orange-50 transition-colors shadow-lg"
            >
              📞 {PHONE}
            </a>
            <Link
              href="/contact"
              className="bg-orange-500 hover:bg-orange-400 text-white font-bold px-6 py-3.5 rounded-2xl transition-colors"
            >
              Book Online →
            </Link>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-2 mb-3">
              <span className="bg-red-900 text-orange-300 text-xs font-bold px-2.5 py-1 rounded-full border border-orange-700">
