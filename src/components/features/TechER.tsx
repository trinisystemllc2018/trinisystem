      ...
      <AnimatePresence mode="wait">
        ...
        {stage === "result" && fix && sev && (
          <motion.div key="result" initial={{ opacity: 0, scale: 0.97 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0 }} transition={{ duration: 0.4 }} className="p-6 md:p-8">
            ...
            {/* Discord CTA */}
            <div className="flex items-center justify-center gap-3 p-4 rounded-2xl bg-indigo-50 border border-indigo-100 mb-3">
              <svg className="w-6 h-6 text-indigo-500 shrink-0" viewBox="0 0 24 24" fill="currentColor">
              ...
              <div className="text-sm">
                <p className="font-bold text-indigo-700">Need live help? Join our Discord</p>
                <p className="text-indigo-500 text-xs">Free community support · Real techs answer 24/7</p>
              </div>
              <a href="https://discord.gg/trinisystem" target="_blank" rel="noopener noreferrer"
                className="ml-auto text-xs font-black text-white bg-indigo-600 hover:bg-indigo-700 px-4 py-2 rounded-xl transition-colors shrink-0">
                Join Free
              </a>
            </div>
